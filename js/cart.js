...
const PRODUCTS = {
  ...
  'chicken-sausage-plain': { name: 'Chicken Sausage (8 patties)',       price: 1800, subPrice: null, image: 'images/placeholder.svg' },
  'chicken-sausage-apple': { name: 'Chicken Apple Sausage (8 patties)', price: 2400, subPrice: null, image: 'images/placeholder.svg' },
...
const PRODUCT_WEIGHTS = {
  ...
  'cultured-butter':    1.0,
  'farm-eggs':          1.5,
  'chicken-sausage-plain': 1.5,
  'chicken-sausage-apple': 1.5,
  'harvest-basket':     5.0,
...
function renderCart() {
  ...
  cart.items.filter(({ id, name }) => PRODUCTS[id] || name).forEach(({ id, qty, price: itemPrice, name: storedName }) => {
    ...
    if ((id === 'sampler-box' || id === 'chicken-dinner-roll-bundle') && adminSub && adminSub.token === id && adminSub.includedItems && adminSub.includedItems.length) {
